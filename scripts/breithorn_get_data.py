...
def get_data():
    ...
    download_file(weather_url, weather_fl, "weather.dat")
    ...
    download_file(mask_zip_url, mask_zip_path, "mask_breithorngletscher.asc")
    ...
    download_file(dem_zip_url, dem_zip_path, "dhm200_cropped.asc")
